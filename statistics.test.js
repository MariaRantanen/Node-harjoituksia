...
// Define array and number of decimals for test
...
// TÄSSÄ TAPAUKSESSA EI OLISI PAKKO LUODA STATTOTEST7 VAAN VOISIMME KÄYTTÄÄ MYÖS STATTOTEST6!!
const statToTest7 = new stats.ArrayStats(testArray6, numberOfDecimals);

test('Standard deviation should be 1 ', () => {
    expect(statToTest7.populationStdDev()).toBeCloseTo(1, 1);
});
