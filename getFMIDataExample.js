...
const observationtimeValuePair = new WeatherObservationTimeValuePair('Turku','wd_10min', 'wind_direction');
...
const forecastTimeValuePair = new WeatherForecastTimeValuePair('Turku', 'WindDirection', 'wind_direction')
